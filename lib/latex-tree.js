...
export default {
    ...
    activate(state) {
        this.treeView = new LatexTreeView(state.latexTreeViewState);
        ...
        // TODO: refine deserialise and deactivation processes
    ...
    // TODO: serialize and deserialise?
    /*
    serialize() {
        return {
            latexTreeViewState: this.treeView.serialize()
        };
    },
    */
